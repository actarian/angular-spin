...
export const environment = {
	...
	plugins: {
		facebook: {
			appId: 389946354375231, // 2034439646874649, // eurospin-viaggi.wslabs.it
			fields: 'id,name,first_name,last_name,email,gender,picture,cover,link',
			scope: 'public_profile, email',
			tokenClient: '904d2aca81775c9c538cbf76ba1d6781', // '643f8b0780f14625b35a450c83b715dc', // eurospin-viaggi.wslabs.it
			version: 'v3.0',
		},
		google: {
